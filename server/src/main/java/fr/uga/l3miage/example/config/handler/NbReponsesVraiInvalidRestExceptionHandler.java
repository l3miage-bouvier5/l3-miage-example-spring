...
public class NbReponsesVraiInvalidRestExceptionHandler {
     ...
     * {@link TestIntIsZeroRestException}.<br>
     * Ici lorsque le code va lever l'exception {@link TestIntIsZeroRestException}
     * alors la fonction <b color="blue">handle()</b> sera appelée.<br>
     * Les annotations :
     * <ul>
