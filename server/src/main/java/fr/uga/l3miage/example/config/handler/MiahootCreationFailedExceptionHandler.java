...
/**
 * Cette classe correspond au handler d'exception rest. Ici, on catch l'exception {@link MiahootAlreadyExistRestException}<br>
 * Les annotations :
 * <ul>
...
public class MiahootCreationFailedExceptionHandler {
    /**
     * Cette classe correspond au handler de l'exception {@link MiahootAlreadyExistRestException}.<br>
     * Ici lorsque le code va lever l'exception {@link MiahootAlreadyExistRestException} alors la fonction <b color="blue">handle()</b> sera appelée.<br>
     * Les annotations :
     * <ul>
