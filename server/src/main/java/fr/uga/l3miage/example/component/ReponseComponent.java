...
public class ReponseComponent {
    ...
    public void updateReponse(final ReponseEntity entity) throws LabelAlreadyExistException,  ReponseEntityNotFoundException{
        if (reponseRepository.findByLabel(entity.getLabel()).isPresent()) {
            ...
            throw new ReponseEntityNotFoundException(String.format("Aucune entité n'a été trouvée pour le label [%s]", entity.getLabel()), entity.getLabel());
        }
    }
}