...
/**
 * Pour respecter l'architecture hexagonale, ici nous ne traitons que les
 * données
 * <br>
 * Les Annotations :
 * <ul>
 * <li>{@link Component} permet de créer un composant spring, cette annotation
 * est en quelque sorte un stéréotype d'un @{@link Bean}, car elle va permettre
 * de créer un candidat à l'injection.</li>
 ...
 * Voir la doc <a href=
 * "https://projectlombok.org/features/constructor">projectlombok/feature/RequiredArgConstructor</a></li>
 * </ul>
 */
@Component
...
public class QuestionComponent {
    ...
    public QuestionEntity getQuestion(final String label) throws QuestionEntityNotFoundException {
        return questionRepository.findByLabel(label)
                .orElseThrow(() -> new QuestionEntityNotFoundException(
    ...
    public void createQuestion(final QuestionEntity entity)
            throws NbReponsesVraiInvalidException, DuplicationLabelReponsePourUneQuestionException {
    ...
    public static int nbReponsesVrai(QuestionEntity entity) {
    ...
    public static boolean existeRepetitionLabelReponses(Set<ReponseEntity> reponses) {
