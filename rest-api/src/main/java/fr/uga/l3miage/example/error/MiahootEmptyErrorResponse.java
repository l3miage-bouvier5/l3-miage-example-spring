...
@JsonTypeName(MiahootEmptyErrorResponse.TYPE_NAME)
@ToString(callSuper = true, exclude = "errorCodeSwaggerDocumentation")
@EqualsAndHashCode(callSuper = true)
public class MiahootEmptyErrorResponse extends ErrorResponse {

    protected static final String TYPE_NAME = "MIAHOOT_EMPTY_ERROR";
    ...
    @Builder
    @Jacksonized
    public MiahootEmptyErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage) {
