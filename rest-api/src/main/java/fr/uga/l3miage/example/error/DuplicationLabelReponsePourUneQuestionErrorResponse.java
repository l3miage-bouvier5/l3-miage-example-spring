...
public class DuplicationLabelReponsePourUneQuestionErrorResponse extends ErrorResponse{
    protected static final String TYPE_NAME = "AER_QUESTION_IS_NOT_FOUND";

    @Schema(name = "errorCode", description = "AER_Ce code d'erreur est aussi le discriminant pour le polymorphisme", allowableValues = TYPE_NAME,
    ...
    @Schema(description = "AER_le label utilisé pour la recherche",example = "AER_donner une réponse ?")
    private final CreateQuestionRequest request;

    @Builder
    @Jacksonized
    public DuplicationLabelReponsePourUneQuestionErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage, CreateQuestionRequest request) {
