 ...
 * {@link ErrorResponse} pour pouvoir désérialiser la bonne erreur.</li>
...
public class MiahootAlreadyExistErrorResponse extends ErrorResponse {
     ...
     */
    protected static final String TYPE_NAME = "MIAHOOT_ALREADY_EXIST_ERROR";
    ...
    @Builder
    @Jacksonized
    public MiahootAlreadyExistErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode,
            String errorMessage) {
