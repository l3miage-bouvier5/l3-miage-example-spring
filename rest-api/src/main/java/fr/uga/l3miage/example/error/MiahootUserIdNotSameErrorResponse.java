...
public class MiahootUserIdNotSameErrorResponse extends ErrorResponse {

    protected static final String TYPE_NAME = "MIAHOOT_USER_ID_NOT_SAME";
    ...
    @Builder
    @Jacksonized
    public MiahootUserIdNotSameErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage) {
